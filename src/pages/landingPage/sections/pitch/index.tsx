        ...
        <div className={styles.content_div}>
          ...
          <div className={styles.text_div}>
            <p className={styles.paragraph}>
              ...
              transform Ekiti State?
              <br />
              DevFest Ado-Ekiti 2023 is here to support you! We're thrilled to
              announce our startup <br />
              pitch session, where you have the opportunity to present your
            ...
            <p className={styles.paragraph}>
              ...
              your idea, its impact,
              <br /> and how you plan to execute it. Selected startups will be
              invited to pitch live at DevFest <br />
              Ado-Ekiti 2023. Let's work together to bring your startup dreams
              to life! DevFest <br />
              Ado-Ekiti 2023 is not just an event; it's a platform where
              innovations take flight.We look <br />
              forward to hearing about your exciting ideas!
            </p>
